...
//        grabber.setAudioCodecName("aac");
        ...
        System.out.println("grabber.start(): " + System.currentTimeMillis()/1000);
        grabber.start();
        System.out.println("grabber.start() end: " + System.currentTimeMillis()/1000);
...
//        recorder.setFrameRate(grabber.getFrameRate());
        // 两个关键帧之间的帧数
//        recorder.setGopSize(grabber.get);
...
//                (System.currentTimeMillis()-startTime)/1000);
    ...
    public static void main(String[] args) throws Exception {
        PushMp4.grabAndPush(RTSP_PATH, SRS_PUSH_ADDRESS);
    }
}